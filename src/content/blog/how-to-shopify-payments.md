---
title: "How to Set Up Shopify Payments in 2026"
slug: "how-to-shopify-payments"
pubDate: 2026-05-05
description: "Learn how to enable Shopify Payments in 10-15 minutes. Step-by-step guide covers eligibility, setup, and payouts. Save on transaction fees today."
author: "Alex Morgan"
...
- **Location:** Your business must be based in a supported country. For this guide, we're focusing on the United States.
- **Prohibited businesses:** Shopify maintains a list of restricted product categories including firearms, adult content, certain supplements, and CBD. Check the [Shopify Payments Terms of Service](https://www.shopify.com/legal/terms-payments-us) before proceeding.
- **Identity verification:** You'll need a valid government-issued ID — a driver's license or passport — for identity checks.
- **US bank account:** Payouts require a US-based checking account with a routing number and account number. Personal accounts work for sole proprietors.
- **Active Shopify plan:** You need at least the Basic plan ($39/month as of 2026) or higher. Trial stores cannot process live payments (Shopify, 2026).
...
| Plan | Online Credit Card Rate | In-Person (POS) Rate | Third-Party Gateway Fee |
|------|------------------------|----------------------|------------------------|
| Basic ($39/mo) | 2.9% + 30¢ | 2.6% + 10¢ | 2.0% |
| Shopify ($105/mo) | 2.6% + 30¢ | 2.4% + 10¢ | 1.0% |
| Advanced ($399/mo) | 2.4% + 30¢ | 2.2% + 10¢ | 0.6% |
| Plus (custom) | Custom negotiated | Custom negotiated | 0.2% |

*(Shopify Pricing Page, as of 2026)*

Additional fees to know:

- **Chargeback fee:** $15 per dispute. Shopify refunds this if you win the dispute.
- **Currency conversion:** 1.5% on transactions processed in non-USD currencies.
- **Third-party gateway surcharge:** 0.5–2% on top of whatever your external processor charges. This fee disappears when you use Shopify Payments.
...
- Shipping tracking numbers and delivery confirmation
- Customer communication logs
- Screenshots of your refund and return policies
...
| Feature | Shopify Payments | Third-Party Gateway (e.g., Authorize.net) |
|---------|-----------------|------------------------------------------|
| Setup time | 10–15 minutes | 1–5 business days |
| Extra Shopify transaction fee | None | 0.5–2.0% |
| Online credit card rate | 2.4–2.9% + 30¢ | Varies by provider |
| Payout speed (US) | 2 business days | 2–7 business days |
| Shop Pay / Apple Pay / Google Pay | Built-in | Requires manual integration |
| Chargeback management | In Shopify Admin | Separate portal |
| Shopify Protect coverage | Yes (Shop Pay orders) | No |
...
**Next steps:** Now that your payments are set up, check out our guides on [Shopify POS setup](/shopify-pos-setup) for in-person selling, [Shop Pay Installments](/shop-pay-installments-guide) to offer BNPL, and [Shopify Balance](/shopify-balance-review) to manage your payouts more efficiently.